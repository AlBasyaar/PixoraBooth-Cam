...
interface MessagePanelProps {
  ...
  setMessages: React.Dispatch<React.SetStateAction<Array<{ id: string; text: string; x: number; y: number; color: string; fontSize: number }>>>;
}

const MessagePanel: React.FC<MessagePanelProps> = ({ messages, setMessages }) => {
        ...
        <div className="bg-gray-700 rounded-lg p-4 mb-8">
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full bg-gray-600 text-white border-none rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
            />
          </div>
              ...
              {messages.map(message => (
                ...
                >
                  <div className="flex items-center">
                    ...
                    ></div>
                    <div>
                      <p className="text-white font-medium truncate max-w-[180px]" style={{ fontSize: `${message.fontSize / 16}rem` }}>
                        {message.text}
                      </p>
